...
namespace livox_ros
{
                                                  ...
                                                  LivoxLidarEthernetPacket *data, void *client_data)
  {
    ...
    if (dev_type == LivoxLidarDeviceType::kLivoxLidarTypeMid360 || dev_type == LivoxLidarDeviceType::kLivoxLidarTypeMid360s)
    {
    ...
    packet.point_interval = data->time_interval * 100 / data->dot_num;
